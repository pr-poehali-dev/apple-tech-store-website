      ...
      <main className="pt-16">
        <section id="home" className="min-h-screen flex items-center justify-center bg-gradient-to-b from-white to-apple-light px-4">
          <div className="max-w-4xl mx-auto text-center animate-fade-in">
            <h1 className="text-6xl md:text-7xl font-bold text-apple-gray mb-6">Магазин техники Apple</h1>
            <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">Официальные продукты Apple с полной гарантией 1 год.</p>
            <Button 
              size="lg" 
              onClick={() => scrollToSection('catalog')}
